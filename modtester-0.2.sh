...
if [ -d "$PWD/testing" ]
    ...
    then
        cd $STARBOUND_DIR/linux
        rm -rf $STARBOUND_DIR/mods/testing.tmp.pak
        ./asset_packer $OLDPWD/$SELECT_DIR $STARBOUND_DIR/mods/testing.tmp.pak
        exec $STARBOUND_DIR/linux/run-client.sh
elif [ "$1" == "--help" ] || [ "$1" == "-h" ] 
    then
        printf "Welcome to Starbound Mod Tester Version 0.2!\r
Usage: ./modtester-0.2.sh [TARGET FOLDER NAME or --help or -h]\n
